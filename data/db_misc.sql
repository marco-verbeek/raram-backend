...
UPDATE raram.users SET raram_date = '2021-04-17 06:00:00' WHERE summoner_name = 'ItsNexty';
...
SELECT raram_date, raram_amount FROM raram.users WHERE summoner_name = 'ItsNexty'